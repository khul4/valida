        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              <div>
                <Badge variant="default" className="mb-5 py-2 px-3">Project Invora</Badge>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Forget manually checking emails. Our AI Agent instantly detects and collects invoices as soon as they land in your inbox.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      No more manual data validation. Our AI automatically extracts invoice and PO details, flags discrepancies, and ensures everything matches, so you don’t have to
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Once verified, the invoice is automatically sent to the right manager for approval, speeding up payment processing without the follow-up emails.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      To streamline your workflow, which app should we connect to?
                    </label>
                    <InvoiceCombobox
