      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-6 rounded-2xl border border-neutral-200 hover:border-black transition-all duration-300 hover:shadow-lg bg-white"
            >
              <div className="w-12 h-12 rounded-xl bg-neutral-100 group-hover:bg-black transition-colors duration-300 flex items-center justify-center mb-4">
